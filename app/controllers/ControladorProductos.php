...
class ControladorProductos{
    ...
    public static function chequearExistencia($marca,$tipo,$color){
        $conn = DB::Connect();
        $stmt = $conn->prepare("SELECT * FROM producto WHERE producto_marca = :marca AND producto_tipo = :tipo AND producto_color = :color");
    ...
    public static function existeMarca($marca) {
        $conn = DB::Connect();
        $stmt = $conn->prepare("SELECT * FROM producto WHERE producto_marca = :marca");
        $stmt->bindParam(':marca', $marca);
        $stmt->execute();
    ...
    public static function existeTipo($tipo) {
        $conn = DB::Connect();
        $stmt = $conn->prepare("SELECT * FROM producto WHERE producto_tipo = :tipo");
        $stmt->bindParam(':tipo', $tipo);
        $stmt->execute();
    ...
    public static function chequearMarcaTipo($marca,$tipo){
        $conn = DB::Connect();
        $stmt = $conn->prepare("SELECT * FROM producto WHERE producto_tipo = :tipo AND producto_marca = :marca");
        $stmt->bindParam(':tipo', $tipo);
        $stmt->bindParam(':marca', $marca);
        $stmt->execute();
    ...
    public function updetearPrecio($marca,$tipo,$nuevoPrecio,$nuevoStock){
        $conn = DB::Connect();
        try{$stmt = $conn->prepare("UPDATE producto SET producto_precio = :nuevo_precio, producto_stock = producto_stock + :nuevo_stock 
    ...
    public static function insert($producto) {
        try {
            ...
            $stmt = $conn->prepare("INSERT INTO producto (producto_marca, producto_tipo, producto_precio, producto_modelo, producto_color, producto_stock) 
